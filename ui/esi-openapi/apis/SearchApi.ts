...
import type {
  EsiCharactersCharacterIdSearchGet,
} from '../models/index';
import {
    EsiCharactersCharacterIdSearchGetFromJSON,
    EsiCharactersCharacterIdSearchGetToJSON,
} from '../models/index';
...
export class SearchApi extends runtime.BaseAPI {
     ...
     * Search on a string
     */
    async getCharactersCharacterIdSearchRaw(requestParameters: GetCharactersCharacterIdSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCharactersCharacterIdSearchGet>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCharactersCharacterIdSearchGetFromJSON(jsonValue));
    }
     ...
     * Search on a string
     */
    async getCharactersCharacterIdSearch(requestParameters: GetCharactersCharacterIdSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCharactersCharacterIdSearchGet> {
