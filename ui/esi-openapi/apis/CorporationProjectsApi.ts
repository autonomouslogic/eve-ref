...
import type {
  EsiCorporationsProjectsContribution,
  EsiCorporationsProjectsContributors,
  EsiCorporationsProjectsDetail,
  EsiCorporationsProjectsListing,
} from '../models/index';
import {
    EsiCorporationsProjectsContributionFromJSON,
    EsiCorporationsProjectsContributionToJSON,
    EsiCorporationsProjectsContributorsFromJSON,
    EsiCorporationsProjectsContributorsToJSON,
    EsiCorporationsProjectsDetailFromJSON,
    EsiCorporationsProjectsDetailToJSON,
    EsiCorporationsProjectsListingFromJSON,
    EsiCorporationsProjectsListingToJSON,
} from '../models/index';
...
export class CorporationProjectsApi extends runtime.BaseAPI {
     ...
     */
    async getCorporationsProjectsContributionRaw(requestParameters: GetCorporationsProjectsContributionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCorporationsProjectsContribution>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCorporationsProjectsContributionFromJSON(jsonValue));
    }
     ...
     * Get your project contribution
     */
    async getCorporationsProjectsContribution(requestParameters: GetCorporationsProjectsContributionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCorporationsProjectsContribution> {
     ...
     */
    async getCorporationsProjectsContributorsRaw(requestParameters: GetCorporationsProjectsContributorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCorporationsProjectsContributors>> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCorporationsProjectsContributorsFromJSON(jsonValue));
    }
     ...
     * List project contributors
     */
    async getCorporationsProjectsContributors(requestParameters: GetCorporationsProjectsContributorsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCorporationsProjectsContributors> {
     ...
     * Get project details
     */
    async getCorporationsProjectsDetailRaw(requestParameters: GetCorporationsProjectsDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCorporationsProjectsDetail>> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCorporationsProjectsDetailFromJSON(jsonValue));
    }
     ...
     * Get project details
     */
    async getCorporationsProjectsDetail(requestParameters: GetCorporationsProjectsDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCorporationsProjectsDetail> {
     ...
     */
    async getCorporationsProjectsListingRaw(requestParameters: GetCorporationsProjectsListingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCorporationsProjectsListing>> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCorporationsProjectsListingFromJSON(jsonValue));
    }
     ...
     * List corporation projects
     */
    async getCorporationsProjectsListing(requestParameters: GetCorporationsProjectsListingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCorporationsProjectsListing> {
