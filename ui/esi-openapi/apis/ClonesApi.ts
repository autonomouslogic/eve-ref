...
import type {
  EsiCharactersCharacterIdClonesGet,
} from '../models/index';
import {
    EsiCharactersCharacterIdClonesGetFromJSON,
    EsiCharactersCharacterIdClonesGetToJSON,
} from '../models/index';
...
export class ClonesApi extends runtime.BaseAPI {
     ...
     * Get clones
     */
    async getCharactersCharacterIdClonesRaw(requestParameters: GetCharactersCharacterIdClonesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCharactersCharacterIdClonesGet>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCharactersCharacterIdClonesGetFromJSON(jsonValue));
    }
     ...
     * Get clones
     */
    async getCharactersCharacterIdClones(requestParameters: GetCharactersCharacterIdClonesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCharactersCharacterIdClonesGet> {
