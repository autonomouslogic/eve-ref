...
import type {
  EsiAllianceDetail,
  EsiAlliancesAllianceIdIconsGet,
} from '../models/index';
import {
    EsiAllianceDetailFromJSON,
    EsiAllianceDetailToJSON,
    EsiAlliancesAllianceIdIconsGetFromJSON,
    EsiAlliancesAllianceIdIconsGetToJSON,
} from '../models/index';
...
export class AllianceApi extends runtime.BaseAPI {
     ...
     */
    async getAlliancesAllianceIdRaw(requestParameters: GetAlliancesAllianceIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiAllianceDetail>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiAllianceDetailFromJSON(jsonValue));
    }
     ...
     * Get alliance\'s public information
     */
    async getAlliancesAllianceId(requestParameters: GetAlliancesAllianceIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiAllianceDetail> {
     ...
     * Get alliance icon
     */
    async getAlliancesAllianceIdIconsRaw(requestParameters: GetAlliancesAllianceIdIconsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiAlliancesAllianceIdIconsGet>> {
        if (requestParameters['allianceId'] == null) {
            throw new runtime.RequiredError(
                'allianceId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiAlliancesAllianceIdIconsGetFromJSON(jsonValue));
    }
     ...
     * Get alliance icon
     */
    async getAlliancesAllianceIdIcons(requestParameters: GetAlliancesAllianceIdIconsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiAlliancesAllianceIdIconsGet> {
