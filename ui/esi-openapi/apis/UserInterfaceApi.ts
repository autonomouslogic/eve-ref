...
import type {
  EsiPostUiOpenwindowNewmailRequest,
} from '../models/index';
import {
    EsiPostUiOpenwindowNewmailRequestFromJSON,
    EsiPostUiOpenwindowNewmailRequestToJSON,
} from '../models/index';
...
export interface PostUiOpenwindowNewmailRequest {
    xCompatibilityDate: PostUiOpenwindowNewmailXCompatibilityDateEnum;
    esiPostUiOpenwindowNewmailRequest: EsiPostUiOpenwindowNewmailRequest;
    acceptLanguage?: PostUiOpenwindowNewmailAcceptLanguageEnum;
    ifNoneMatch?: string;
    xTenant?: string;
    ifModifiedSince?: string;
}
...
export class UserInterfaceApi extends runtime.BaseAPI {
    ...
    async postUiOpenwindowNewmailRaw(requestParameters: PostUiOpenwindowNewmailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['esiPostUiOpenwindowNewmailRequest'] == null) {
            throw new runtime.RequiredError(
                'esiPostUiOpenwindowNewmailRequest',
                'Required parameter "esiPostUiOpenwindowNewmailRequest" was null or undefined when calling postUiOpenwindowNewmail().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: EsiPostUiOpenwindowNewmailRequestToJSON(requestParameters['esiPostUiOpenwindowNewmailRequest']),
        }, initOverrides);
...
export type PostUiOpenwindowNewmailAcceptLanguageEnum = typeof PostUiOpenwindowNewmailAcceptLanguageEnum[keyof typeof PostUiOpenwindowNewmailAcceptLanguageEnum];
