...
import type {
  EsiCharactersCharacterIdCalendarEventIdAttendeesGetInner,
  EsiCharactersCharacterIdCalendarEventIdGet,
  EsiCharactersCharacterIdCalendarGetInner,
  EsiPutCharactersCharacterIdCalendarEventIdRequest,
} from '../models/index';
import {
    EsiCharactersCharacterIdCalendarEventIdAttendeesGetInnerFromJSON,
    EsiCharactersCharacterIdCalendarEventIdAttendeesGetInnerToJSON,
    EsiCharactersCharacterIdCalendarEventIdGetFromJSON,
    EsiCharactersCharacterIdCalendarEventIdGetToJSON,
    EsiCharactersCharacterIdCalendarGetInnerFromJSON,
    EsiCharactersCharacterIdCalendarGetInnerToJSON,
    EsiPutCharactersCharacterIdCalendarEventIdRequestFromJSON,
    EsiPutCharactersCharacterIdCalendarEventIdRequestToJSON,
} from '../models/index';
...
export interface PutCharactersCharacterIdCalendarEventIdRequest {
    characterId: number;
    eventId: number;
    xCompatibilityDate: PutCharactersCharacterIdCalendarEventIdXCompatibilityDateEnum;
    esiPutCharactersCharacterIdCalendarEventIdRequest: EsiPutCharactersCharacterIdCalendarEventIdRequest;
    acceptLanguage?: PutCharactersCharacterIdCalendarEventIdAcceptLanguageEnum;
    ifNoneMatch?: string;
    xTenant?: string;
    ifModifiedSince?: string;
}
...
export class CalendarApi extends runtime.BaseAPI {
     ...
     */
    async getCharactersCharacterIdCalendarRaw(requestParameters: GetCharactersCharacterIdCalendarRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EsiCharactersCharacterIdCalendarGetInner>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(EsiCharactersCharacterIdCalendarGetInnerFromJSON));
    }
     ...
     * List calendar event summaries
     */
    async getCharactersCharacterIdCalendar(requestParameters: GetCharactersCharacterIdCalendarRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EsiCharactersCharacterIdCalendarGetInner>> {
     ...
     * Get an event
     */
    async getCharactersCharacterIdCalendarEventIdRaw(requestParameters: GetCharactersCharacterIdCalendarEventIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiCharactersCharacterIdCalendarEventIdGet>> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiCharactersCharacterIdCalendarEventIdGetFromJSON(jsonValue));
    }
     ...
     * Get an event
     */
    async getCharactersCharacterIdCalendarEventId(requestParameters: GetCharactersCharacterIdCalendarEventIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiCharactersCharacterIdCalendarEventIdGet> {
     ...
     * Get attendees
     */
    async getCharactersCharacterIdCalendarEventIdAttendeesRaw(requestParameters: GetCharactersCharacterIdCalendarEventIdAttendeesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EsiCharactersCharacterIdCalendarEventIdAttendeesGetInner>>> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(EsiCharactersCharacterIdCalendarEventIdAttendeesGetInnerFromJSON));
    }
     ...
     * Get attendees
     */
    async getCharactersCharacterIdCalendarEventIdAttendees(requestParameters: GetCharactersCharacterIdCalendarEventIdAttendeesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EsiCharactersCharacterIdCalendarEventIdAttendeesGetInner>> {
    ...
    async putCharactersCharacterIdCalendarEventIdRaw(requestParameters: PutCharactersCharacterIdCalendarEventIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['esiPutCharactersCharacterIdCalendarEventIdRequest'] == null) {
            throw new runtime.RequiredError(
                'esiPutCharactersCharacterIdCalendarEventIdRequest',
                'Required parameter "esiPutCharactersCharacterIdCalendarEventIdRequest" was null or undefined when calling putCharactersCharacterIdCalendarEventId().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: EsiPutCharactersCharacterIdCalendarEventIdRequestToJSON(requestParameters['esiPutCharactersCharacterIdCalendarEventIdRequest']),
        }, initOverrides);
...
export type PutCharactersCharacterIdCalendarEventIdAcceptLanguageEnum = typeof PutCharactersCharacterIdCalendarEventIdAcceptLanguageEnum[keyof typeof PutCharactersCharacterIdCalendarEventIdAcceptLanguageEnum];
