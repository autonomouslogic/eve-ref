...
import {
    ...
    EsiWarsWarIdGetFromJSON,
    EsiWarsWarIdGetToJSON,
} from '../models/index';
...
export class WarsApi extends runtime.BaseAPI {
     ...
     * Get war information
     */
    async getWarsWarIdRaw(requestParameters: GetWarsWarIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EsiWarsWarIdGet>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EsiWarsWarIdGetFromJSON(jsonValue));
    }
     ...
     * Get war information
     */
    async getWarsWarId(requestParameters: GetWarsWarIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EsiWarsWarIdGet> {
     ...
     */
    async getWarsWarIdKillmailsRaw(requestParameters: GetWarsWarIdKillmailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EsiCharactersCharacterIdKillmailsRecentGetInner>>> {
        if (requestParameters['warId'] == null) {
            throw new runtime.RequiredError(
                'warId',
     ...
     * List kills for a war
     */
    async getWarsWarIdKillmails(requestParameters: GetWarsWarIdKillmailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EsiCharactersCharacterIdKillmailsRecentGetInner>> {
