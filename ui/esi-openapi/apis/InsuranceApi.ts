...
import type {
  EsiInsurancePricesGetInner,
} from '../models/index';
import {
    EsiInsurancePricesGetInnerFromJSON,
    EsiInsurancePricesGetInnerToJSON,
} from '../models/index';
...
export class InsuranceApi extends runtime.BaseAPI {
     ...
     */
    async getInsurancePricesRaw(requestParameters: GetInsurancePricesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EsiInsurancePricesGetInner>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(EsiInsurancePricesGetInnerFromJSON));
    }
     ...
     * List insurance levels
     */
    async getInsurancePrices(requestParameters: GetInsurancePricesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EsiInsurancePricesGetInner>> {
