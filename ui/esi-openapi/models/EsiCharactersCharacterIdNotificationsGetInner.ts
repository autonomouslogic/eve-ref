 ...
 * 
 * @export
 * @interface EsiCharactersCharacterIdNotificationsGetInner
 */
export interface EsiCharactersCharacterIdNotificationsGetInner {
    /**
     * 
     * @type {boolean}
     * @memberof EsiCharactersCharacterIdNotificationsGetInner
     */
    isRead?: boolean;
    /**
     * 
     ...
     * @memberof EsiCharactersCharacterIdNotificationsGetInner
     */
    senderType: EsiCharactersCharacterIdNotificationsGetInnerSenderTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof EsiCharactersCharacterIdNotificationsGetInner
     ...
     * @memberof EsiCharactersCharacterIdNotificationsGetInner
     */
    type: EsiCharactersCharacterIdNotificationsGetInnerTypeEnum;
}
 ...
 * @export
 */
export const EsiCharactersCharacterIdNotificationsGetInnerSenderTypeEnum = {
    Character: 'character',
...
export type EsiCharactersCharacterIdNotificationsGetInnerSenderTypeEnum = typeof EsiCharactersCharacterIdNotificationsGetInnerSenderTypeEnum[keyof typeof EsiCharactersCharacterIdNotificationsGetInnerSenderTypeEnum];

/**
 * @export
 */
export const EsiCharactersCharacterIdNotificationsGetInnerTypeEnum = {
...
export type EsiCharactersCharacterIdNotificationsGetInnerTypeEnum = typeof EsiCharactersCharacterIdNotificationsGetInnerTypeEnum[keyof typeof EsiCharactersCharacterIdNotificationsGetInnerTypeEnum];


/**
 * Check if a given object implements the EsiCharactersCharacterIdNotificationsGetInner interface.
 */
export function instanceOfEsiCharactersCharacterIdNotificationsGetInner(value: object): value is EsiCharactersCharacterIdNotificationsGetInner {
...
export function EsiCharactersCharacterIdNotificationsGetInnerFromJSON(json: any): EsiCharactersCharacterIdNotificationsGetInner {
    return EsiCharactersCharacterIdNotificationsGetInnerFromJSONTyped(json, false);
}

export function EsiCharactersCharacterIdNotificationsGetInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): EsiCharactersCharacterIdNotificationsGetInner {
    if (json == null) {
        return json;
    }
    return {
...
export function EsiCharactersCharacterIdNotificationsGetInnerToJSON(json: any): EsiCharactersCharacterIdNotificationsGetInner {
    return EsiCharactersCharacterIdNotificationsGetInnerToJSONTyped(json, false);
}

export function EsiCharactersCharacterIdNotificationsGetInnerToJSONTyped(value?: EsiCharactersCharacterIdNotificationsGetInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
