...
public class ArchivePathFactoriesTest {
	...
	private static void testParseSequenceOnly(ArchivePathFactory factory, long sequenceNumber, String path) {
		assertEquals(sequenceNumber, (long) factory.parseSequenceNumber(path));
		assertNull(factory.parseArchiveTime(path));
	}
